                                ...
                                <tbody>
                                    <?php foreach ($data as $d) : ?>
                                        <tr>
                                            <td><?= $d['desc']; ?></td>
                                            <td><?= $d['name']; ?></td>
                                            <td><img height="250px" width="150px" src="upload/<?= $d['img']; ?>" alt="img"></td>
                                            <td><a href="updateportfolio.php?portfolioid=<?= $d['id']; ?>" class="btn btn-success">Update</a> </td>
                                            <td><a href="deleteportfolio.php?portfolioid=<?= $d['id']; ?>" class="btn btn-danger">Delete</a> </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                                <tfoot>
