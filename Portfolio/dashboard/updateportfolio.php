...
if (isset($_POST['desc'])) {
    ...
    $res = updateportfolio($portfolioid, $desc, $filename);
    ...
    $data = GetPortfolioById($portfolioid);
}
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <?php if (isset($success) or isset($error)) : ?>
                        <div class="alert <?php if (isset($success)) : ?> alert-success  <?php else : ?> alert-danger <?php endif; ?> alert-dismissible text-white">
                        ...
                        <form role="form" action="updateportfolio.php" method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control textarea" name="desc"><?= $data['desc'] ?></textarea>
                                </div>
                                <img src="upload/<?= $data['img'] ?>" width="100px" height="100px">
                                <div class="form-group">
